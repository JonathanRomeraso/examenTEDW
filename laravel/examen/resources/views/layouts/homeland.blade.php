...
<html lang="en">
  ...
  <body>
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown arrow-top">
                          <li><a href="/type/Condo">Condo</a></li>
                          <li><a href="/type/Property Land">Property Land</a></li>
                          <li><a href="/type/Comercial Building">Commercial Building</a></li>
    ...
    <script src="{{ asset('js/forms/homeland.js') }}"></script>

    <script src="{{ asset('js/forms/register.js') }}"></script>
    <script src="{{ asset('js/forms/contact.js') }}"></script>
