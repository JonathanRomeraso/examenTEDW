...
@section('content')
    @include('partials.cover', ['title' => 'Contact Us'])
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    <div class="site-section-title ">
                        <h2 id="responseMessage" class="alert alert-primary" style="display: none;"></h2>
                    </div>
                    <form id="contactForm" action="" method="POST" class="p-5 bg-white border">
                ...
                <div class="col-lg-4">
                    <div class="p-4 mb-3 bg-white">
                        ...
                        <p class="mb-4">Avenida Tecnologivo, Celaya, Guanajuato</p>

                        <p class="mb-0 font-weight-bold">Phone</p>
                        <p class="mb-4"><a href="#">+52 461 2222 445</a></p>

                        <p class="mb-0 font-weight-bold">Email Address</p>
                        <p class="mb-0"><a href="#">21030021@itcelaya.edu.mx</a></p>
                    </div>
                </div>
            </div>
        </div>
